                ...
                if onScreen then
                    ...
                    if ESP_SETTINGS.ShowBox and ESP_SETTINGS.Enabled then
                        ...
                        elseif ESP_SETTINGS.BoxType == "Corner Box Esp" then
                            ...
                            -- Assuming boxLines is already created and initialized properly
                            -- Example: Initialize boxLines globally or wherever it's needed
                            local boxLines = {}
                            
                            -- Example function to initialize or recreate box lines for players or parts
                            local function InitializeBoxLines()
                                -- Clear the previous box lines if necessary
                                for i = 9, 16 do
                                    -- Make sure boxLines[i] exists, or create it
                                    if not boxLines[i] then
                                        boxLines[i] = create("Square", {  -- Replace with your own creation method
                                            Color = ESP_SETTINGS.BoxOutlineColor,
                                            Thickness = 2,
                                            Filled = false
                                        })
                            ...
                            -- Call this function to initialize box lines when needed (for example, on player join)
                            InitializeBoxLines()
                            
                            -- Continuously update box outline color using Heartbeat
                            RunService.Heartbeat:Connect(function()
                                -- Ensure boxLines are initialized before updating
                                InitializeBoxLines()
                            
                                -- Update box outlines with the current color
                                for i = 9, 16 do
                                    if boxLines[i] then
                                        boxLines[i].Thickness = 2
                                        boxLines[i].Color = ESP_SETTINGS.BoxOutlineColor  -- Use the updated color
